class LearningsController < ApplicationController
  ...
  def learning_create_back_last_month
  ...
  def learning_create_back_two_month
      @learning = Learning.find(learning_params)
      @this_month = Date.today.month
      @last_month = if @this_month == 1
              12
  ...
  def learning_create_front_this_month
      @learning = Learning.find(learning_params)
      @month = Date.today.month
      @year = Date.today.year
  ...
  def learning_create_front_last_month
      @learning = Learning.find(learning_params)
      @this_month= Date.today.month
      @month = if @this_month == 1
              12
  ...
  def learning_create_front_two_month
      @learning = Learning.find(learning_params)
      @this_month = Date.today.month
      @last_month = if @this_month == 1
              12
  ...
  def learning_create_infra_this_month
      @learning = Learning.find(learning_params)
      @month = Date.today.month
      @year = Date.today.year
      @engineer_role = "インフラ"
  ...
  def learning_create_infra_last_month
      @learning = Learning.find(learning_params)
      @this_month= Date.today.month
      @month = if @this_month == 1
              12
  ...
  def learning_create_infra_two_month
      @learning = Learning.find(learning_params)
      @this_month = Date.today.month
      @last_month = if @this_month == 1
              12
